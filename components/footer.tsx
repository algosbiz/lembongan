      ...
      <div className="mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p>Mobile: +62 8123 741 8850</p>
            <p>Email: info@legend-diving.com</p>
          </div>
        ...
        {/* Copyright statement */}
        <div className="py-4 text-center text-gray-300">©Copyright 2012-{new Date().getFullYear()} | Jalan Raya Jungut Batu, Nusa Lembongan, Bali Indonesia | info@divinglembongan.com | Phone: +6281237418850 | All rights reserved</div>
