...
import { PinContainerNew } from "./ui/3dPinNew";
...
export function AnimatedPinNew({ titles, heading, description, imageSrc, imageAlt = "background image", iconSrc }: AnimatedPinProps) {
  return (
    <div className="h-full z-10  flex items-center justify-center">
      <PinContainerNew titles={titles}>
        <div className="relative w-[650px] h-[22rem] rounded-br-[40px] rounded-bl-sm rounded-tl-sm rounded-tr-sm overflow-hidden shadow-lg">
          {/* Background Image */}
